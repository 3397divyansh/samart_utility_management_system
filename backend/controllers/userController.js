...
const bookWorker = async (req, res) => {
    ...
    try {
        ...
        // Update only the dates and owner fields
...
const addSelfAsWorker = async (req, res) => {
    ...
    const userId = req.userId; // Assuming `req.user` is populated by middleware after JWT verification
...
module.exports = {
    ...
    Login,
    SignUp,
    addSelfAsWorker // Add this export
};
